...
const ChatMessage = ({ message, isUser }) => (
    <div>
        {isUser ? (
            ...
            <div className="w-fit px-4 py-4 grid grid-cols-[40px_1fr] items-start gap-x-4">
                <div
                    className="flex items-center justify-center w-[35px] h-[35px] rounded-xl mt-2"
                    style={{ background: "linear-gradient(180deg, #8F00FF 0%, #FE00E4 100%)",}}
                >
                    <Molecule />
                </div>
